	...
	<div>
		...
		<section class="py-10 overflow-hidden">
			<div class="container mx-auto">
				<div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-5 md:gap-10">
					<div>
					...
					<div>
						<h5 class="mt-10 mb-3 text-lg font-bold font-heading text-gray-900">Minimum Bet</h5>
						<p>Minimum Bet is 0.00000001 NANO, any amount lower than this will be considered as spam.</p>
					</div>
				</div>
			</div>
		</section>
